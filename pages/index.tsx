...
const Home = () => {
  return (
    <>
      <section id="intro" className="h-[calc(100vh_-_100px)] flex items-center text-gray-400/90">
      ...
      <section id="about" className="pt-20 sm:pt-36 flex justify-center flex-col text-base text-gray-400/90">
        ...
        <p className="pb-4 text-lg leading-relaxed">
          ...
          <a href="https://cimpress.com/" className="text-white hover:underline underline-offset-4">
            Cimpress
          </a>
        ...
        <p className="pb-4 text-lg leading-relaxed">
          ...
          <a href="https://www.cognizant.com/in/en" className="text-white hover:underline underline-offset-4">
            Cognizant
          </a>
        ...
        <Link href="/resume.pdf" passHref>
          <a
            className="border rounded-md px-4 py-2 bg-white text-primary font-bold flex w-fit gap-2 items-center shadow"
            target="_blank"
            rel="noopener noreferrer"
          >
      ...
      <section id="work" className="pt-20 sm:pt-36 flex justify-center flex-col text-base text-gray-400/90">
